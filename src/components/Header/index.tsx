...
function Header({ history }: { history: any }) {
  ...
  return (
    <HeaderFrame>
      <HeaderRow isDark={isDark}>
        <Title href=".">
          <DXswapIcon>
            <img src="https://raw.githubusercontent.com/cyberminter/jellybeanswap-branding/main/brand/logo.png" alt="logo" width="80" />
          </DXswapIcon>
        </Title>
        <HeaderLinks>
  ...
  /*
     ...
     <StyledExternalLink id={`stake-nav-link`} href={`https://cyberminter.com/`}>
            CyberMint{' '}
            <Text ml="4px" fontSize="11px">
              ↗
            </Text>
           ...
           <StyledExternalLink id={`stake-nav-link`} href={`https://cybermint.finance/`}>
            PixalFish{' '}
            <Text ml="4px" fontSize="11px">
              ↗
            </Text>
