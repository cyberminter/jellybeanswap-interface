...
const ROUTABLE_PLATFORM_LOGO: { [routablePaltformName: string]: ReactNode } = {
  ...
  [RoutablePlatform.HONEYSWAP.name]: <img width={16} height={16} src={ "https://raw.githubusercontent.com/cyberminter/jellybeanswap-branding/b0dba69685dcb6a6a5fdb0ae24e60749979bb40d/brand/logo.svg" } alt="Jelly Bean Swap" />,
  ...
  [RoutablePlatform.Etcswap.name]: <img width={16} height={16} src={ "https://swap.ethereumclassic.com/static/media/ethereum-classic-logo.b63a172a.png" } alt="Etcswap" />,
  [RoutablePlatform.Hebeswap.name]: <img width={16} height={16} src={ "https://app.hebeswap.com/favicon.png" } alt="Hebeswap" />
