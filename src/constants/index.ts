...
import { ChainId, JSBI, Percent, CurrencyAmount, WETH, WSPOA, WXDAI, Token, Currency, WMATIC, WETC } from 'dxswap-sdk'
import { tokens } from './tokens'
import { injected, walletConnectETC, walletlink } from '../connectors'
...
export const brightCoin = new Token(
  ChainId.ETC,
  '0x3d39756b1FF9C68a4E552aE5722cFAF4b8BdB543',
  3,
  'Blub',
  'Bright coin'
)
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.ETC]: [WETC[ChainId.ETC], brightCoin]
...
export const SUPPORTED_WALLETS: { [key: string]: WalletInfo } = {
  ...
  WALLET_CONNECT_ETC: {
    connector: walletConnectETC,
    name: 'WalletConnect for Ethereum Classic',
    iconName: 'wallet-connect.svg',
    description: 'Connect to all different types of wallets and more...',
    href: null,
    color: '#4196FC',
    mobile: true
  },
...
export const NETWORK_DETAIL: { [chainId: number]: NetworkDetails } = {
  ...
  [ChainId.ETC]: {
    ...
    nativeCurrency: {
      name: Currency.ETC.name || 'ETC',
      symbol: Currency.ETC.symbol || 'ETC',
      decimals: Currency.ETC.decimals || 18
    },
