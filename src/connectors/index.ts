...
export const network = new CustomNetworkConnector({
  urls: {
    ...
    [ChainId.ETC]: 'https://www.ethercluster.com/etc'

  },
  defaultChainId: ChainId.ETC
})

export const injected = new InjectedConnector({
  supportedChainIds: [ChainId.ETC]
})

export const walletlink = new WalletLinkConnector({
  supportedChainIds: [ChainId.ETC],
  url: '',
  appName: 'JellyBeanSwap'
})

// etc only
export const walletConnectETC = new WalletConnectConnector({
  rpc: {
